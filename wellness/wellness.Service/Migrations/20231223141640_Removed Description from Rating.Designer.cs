...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20231223141640_Removed Description from Rating")]
    partial class RemovedDescriptionfromRating
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 23, 14, 16, 40, 152, DateTimeKind.Utc).AddTicks(6482),
                            TokenExpires = new DateTime(2023, 12, 23, 15, 16, 40, 152, DateTimeKind.Utc).AddTicks(6483),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 23, 14, 16, 40, 152, DateTimeKind.Utc).AddTicks(6807),
                            TokenExpires = new DateTime(2023, 12, 23, 15, 16, 40, 152, DateTimeKind.Utc).AddTicks(6807),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 23, 14, 16, 40, 152, DateTimeKind.Utc).AddTicks(7056),
                            TokenExpires = new DateTime(2023, 12, 23, 15, 16, 40, 152, DateTimeKind.Utc).AddTicks(7057),
                            UserName = "worker"
                        });
                });
