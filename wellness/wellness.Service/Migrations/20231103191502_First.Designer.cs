...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20231103191502_First")]
    partial class First
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2023, 11, 3, 19, 15, 1, 797, DateTimeKind.Utc).AddTicks(9715),
                            TokenExpires = new DateTime(2023, 11, 3, 20, 15, 1, 797, DateTimeKind.Utc).AddTicks(9717),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2023, 11, 3, 19, 15, 1, 797, DateTimeKind.Utc).AddTicks(9893),
                            TokenExpires = new DateTime(2023, 11, 3, 20, 15, 1, 797, DateTimeKind.Utc).AddTicks(9894),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2023, 11, 3, 19, 15, 1, 798, DateTimeKind.Utc).AddTicks(56),
                            TokenExpires = new DateTime(2023, 11, 3, 20, 15, 1, 798, DateTimeKind.Utc).AddTicks(57),
                            UserName = "worker"
                        });
                });
