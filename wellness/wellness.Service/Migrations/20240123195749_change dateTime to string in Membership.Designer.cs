...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20240123195749_change dateTime to string in Membership")]
    partial class changedateTimetostringinMembership
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2024, 1, 23, 19, 57, 48, 472, DateTimeKind.Utc).AddTicks(3087),
                            TokenExpires = new DateTime(2024, 1, 23, 20, 57, 48, 472, DateTimeKind.Utc).AddTicks(3090),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2024, 1, 23, 19, 57, 48, 472, DateTimeKind.Utc).AddTicks(3534),
                            TokenExpires = new DateTime(2024, 1, 23, 20, 57, 48, 472, DateTimeKind.Utc).AddTicks(3535),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2024, 1, 23, 19, 57, 48, 472, DateTimeKind.Utc).AddTicks(3897),
                            TokenExpires = new DateTime(2024, 1, 23, 20, 57, 48, 472, DateTimeKind.Utc).AddTicks(3898),
                            UserName = "worker"
                        });
                });
