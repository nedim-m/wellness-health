...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20240213172752_Remove user and treatment from rating fix")]
    partial class Removeuserandtreatmentfromratingfix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2024, 2, 13, 17, 27, 51, 649, DateTimeKind.Utc).AddTicks(1236),
                            TokenExpires = new DateTime(2024, 2, 13, 18, 27, 51, 649, DateTimeKind.Utc).AddTicks(1239),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2024, 2, 13, 17, 27, 51, 649, DateTimeKind.Utc).AddTicks(1770),
                            TokenExpires = new DateTime(2024, 2, 13, 18, 27, 51, 649, DateTimeKind.Utc).AddTicks(1771),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2024, 2, 13, 17, 27, 51, 649, DateTimeKind.Utc).AddTicks(2229),
                            TokenExpires = new DateTime(2024, 2, 13, 18, 27, 51, 649, DateTimeKind.Utc).AddTicks(2230),
                            UserName = "worker"
                        });
                });
