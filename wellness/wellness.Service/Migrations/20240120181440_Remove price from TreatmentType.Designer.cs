...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20240120181440_Remove price from TreatmentType")]
    partial class RemovepricefromTreatmentType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2024, 1, 20, 18, 14, 39, 558, DateTimeKind.Utc).AddTicks(534),
                            TokenExpires = new DateTime(2024, 1, 20, 19, 14, 39, 558, DateTimeKind.Utc).AddTicks(537),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2024, 1, 20, 18, 14, 39, 558, DateTimeKind.Utc).AddTicks(721),
                            TokenExpires = new DateTime(2024, 1, 20, 19, 14, 39, 558, DateTimeKind.Utc).AddTicks(721),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2024, 1, 20, 18, 14, 39, 558, DateTimeKind.Utc).AddTicks(892),
                            TokenExpires = new DateTime(2024, 1, 20, 19, 14, 39, 558, DateTimeKind.Utc).AddTicks(892),
                            UserName = "worker"
                        });
                });
