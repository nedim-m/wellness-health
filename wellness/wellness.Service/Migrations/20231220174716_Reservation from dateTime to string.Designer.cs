...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20231220174716_Reservation from dateTime to string")]
    partial class ReservationfromdateTimetostring
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 20, 17, 47, 16, 379, DateTimeKind.Utc).AddTicks(1608),
                            TokenExpires = new DateTime(2023, 12, 20, 18, 47, 16, 379, DateTimeKind.Utc).AddTicks(1611),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 20, 17, 47, 16, 379, DateTimeKind.Utc).AddTicks(1796),
                            TokenExpires = new DateTime(2023, 12, 20, 18, 47, 16, 379, DateTimeKind.Utc).AddTicks(1797),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 20, 17, 47, 16, 379, DateTimeKind.Utc).AddTicks(2235),
                            TokenExpires = new DateTime(2023, 12, 20, 18, 47, 16, 379, DateTimeKind.Utc).AddTicks(2236),
                            UserName = "worker"
                        });
                });
