...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20240213092110_Change amount from int to decimal Transaction")]
    partial class ChangeamountfrominttodecimalTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2024, 2, 13, 9, 21, 9, 857, DateTimeKind.Utc).AddTicks(7749),
                            TokenExpires = new DateTime(2024, 2, 13, 10, 21, 9, 857, DateTimeKind.Utc).AddTicks(7753),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2024, 2, 13, 9, 21, 9, 857, DateTimeKind.Utc).AddTicks(8101),
                            TokenExpires = new DateTime(2024, 2, 13, 10, 21, 9, 857, DateTimeKind.Utc).AddTicks(8102),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2024, 2, 13, 9, 21, 9, 857, DateTimeKind.Utc).AddTicks(8423),
                            TokenExpires = new DateTime(2024, 2, 13, 10, 21, 9, 857, DateTimeKind.Utc).AddTicks(8425),
                            UserName = "worker"
                        });
                });
