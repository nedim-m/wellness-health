...
namespace wellness.Service.Migrations
{
    ...
    [Migration("20231216195314_Added Name to Treatment")]
            ...
            modelBuilder.Entity("wellness.Service.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RoleId = 1,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 16, 19, 53, 14, 342, DateTimeKind.Utc).AddTicks(1319),
                            TokenExpires = new DateTime(2023, 12, 16, 20, 53, 14, 342, DateTimeKind.Utc).AddTicks(1321),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            RoleId = 2,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 16, 19, 53, 14, 342, DateTimeKind.Utc).AddTicks(1498),
                            TokenExpires = new DateTime(2023, 12, 16, 20, 53, 14, 342, DateTimeKind.Utc).AddTicks(1499),
                            UserName = "worker"
                        },
                        new
                        {
                            ...
                            RoleId = 3,
                            Status = true,
                            TokenCreated = new DateTime(2023, 12, 16, 19, 53, 14, 342, DateTimeKind.Utc).AddTicks(1798),
                            TokenExpires = new DateTime(2023, 12, 16, 20, 53, 14, 342, DateTimeKind.Utc).AddTicks(1798),
                            UserName = "worker"
                        });
                });
